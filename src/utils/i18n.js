...
i18n.use(initReactI18next).init({
  resources: {
    ru: {
      ...
      Цель сервиса Prusakova.com - помочь вам быстро справится с трудными жизненными ситуациями и внутренними проблемами.
    ...
    `,
        ...
        service1Description:
          'Индивидуальная консультация онлайн для взрослых.',
        service2Title: 'Семейная',
        service2Description:
          'Консультация онлайн для семей и пар.',
        ...
        project1Description:
          'Разработка современного корпоративного сайта для крупной компании.',
        project2Title: 'Мобильное приложение',
        project2Description:
          'Создание инновационного мобильного приложения для стартапа.',
        project3Title: 'IT-инфраструктура',
        project3Description:
          'Оптимизация IT-инфраструктуры для повышения эффективности бизнес-процессов.',
        contacts: 'Контакты',
        contactInfo: 'Контактная информация',
        address: 'Адрес',
        addressValue: 'г. Москва, ул. Примерная, д. 123',
        phone: 'Телефон',
